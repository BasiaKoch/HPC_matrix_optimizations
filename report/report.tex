...
of global synchronisation steps and improves scalability. This version
(\texttt{v4\_openmp\_blocked}) achieves a speedup of 59.5$\times$ and a
parallel efficiency of 78.2\% at 76 threads for $n=8000$.
...
182.7~GFLOP/s at 76 threads for $n=8000$,
representing a 24\% improvement over \texttt{v4\_openmp\_blocked} at 76 threads.
\end{abstract}
...
The final implementation (\texttt{v5\_openmp\_blocked}, tag
\texttt{v0.6-cache-opts}) achieves 182.7~GFLOP/s at 76 threads for $n=8000$.
...
with tags \texttt{v0.1-baseline} through \texttt{v0.6-cache-opts}.
The final, fully optimised implementation is
\texttt{cholesky\_v5\_openmp\_blocked.c} (tag \texttt{v0.6-cache-opts});
